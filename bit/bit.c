...
{
    br_arg_set(context, args, 0, bruter_value_i(~br_arg_get(context, args, 0).i));
    return -1;
}
...
BR_FUNCTION(_bit_on)
{
    ...
    br_arg_set(context, args, 0, bruter_value_i(br_arg_get(context, args, 0).i | mask));
    return -1;
}
...
BR_FUNCTION(_bit_swap)
{
    ...
    br_arg_set(context, args, 0, bruter_value_i(br_arg_get(context, args, 0).i & ~(mask | mask2)));
    return -1;
}
